...
{
    class GenerateurDAcier : GenerateurDeRessources
    {
        ...
        {
            List<Ressource> res = new List<Ressource>();
            res.Add(new Ressource { Nom = TypeRessource.OXYGENE.ToString(), DerniereMAJ = DateTime.Now, DerniereQuantite = ((10 * (Niveau / 2)) + 1) });
            return res;
        }
